    ...
    public class YouTubeDownloader
    {
        ...
        public void downloadMP3(string url)
        {
            ...
            if (link != null)
            {
                ...
                string filePath = youTubeDataFeed.entry.title.t.ToString() + ".mp3";
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    wClient.DownloadProgressChanged += _form.wClient_DownloadProgressChanged;
                    _form.setLoadingIconState(false);
                    _form.setProgressBarState(true);
                    wClient.DownloadFileAsync(new System.Uri(fileURL), dialog.FileName);
                    youTubeSong = new Song(youTubeDataFeed.entry.title.t.ToString(), youTubeDataFeed.entry.mediagroup.mediathumbnail[3].url.ToString(), null, dialog.FileName, false, 0);
